...
public class Board extends JPanel implements Serializable {
	...
	public static final String[] COLUMN_NAMES = new String[] { "a", "b", "c", "d", "e", "f", "g", "h" };
	...
	public static final char INITIAL_KING_COLUMN = 'e';

	// Constants for graphics. These variables represent units measured in
	// pixels
	...
	private void drawLetters(Graphics graphics) {
		...
		for (int col = 0; col < COLS; col++) {
			...
			graphics.drawString(letterStr, calculateCoordinate(xOffset, tileWidth, col, true),
					panelHeight - yOffset / 2);
			letter++;
		}
	}
	...
	public String getChessNotation(int row, int col) {
	...
	public void save() throws IOException {
		FileOutputStream fout = new FileOutputStream("C:\\Documents\board.ser");
